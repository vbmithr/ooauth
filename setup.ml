...
(* OASIS_START *)
(* DO NOT EDIT (digest: 4bb0eb9eb0a7871917da9bb2d63b7543) *)
(*
...
let setup_t =
  {
               ...
               Library
                 ({
                      ...
                      },
                   {
                      ...
                      lib_findlib_name = Some "ooauth";
                      lib_findlib_containers = [];
                      });
               Flag
                 ({
                     cs_name = "client_ocurl";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
                      flag_description = Some "build the ocurl client";
                      flag_default = [(OASISExpr.EBool true, true)];
                      });
               Flag
                 ({
                     cs_name = "client_ocamlnet";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
                      flag_description = Some "build the ocamlnet client";
                      flag_default = [(OASISExpr.EBool true, true)];
                      });
               Flag
                 ({
                     cs_name = "server_ocamlnet";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
                      flag_description = Some "build the ocamlnet server";
                      flag_default = [(OASISExpr.EBool true, true)];
                      });
               Library
                 ({
                     ...
                     },
                   {
                      bs_build =
                        [
                           ...
                           (OASISExpr.EFlag "client_ocurl", true)
                        ];
                      bs_install =
                        [
                           (OASISExpr.EBool true, false);
                      ...
                      bs_path = "client_ocurl";
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [
                           InternalLibrary "ooauth";
                   ...
                   {
                      lib_modules = ["Oauth_ocurl_http_client"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "ooauth";
                      lib_findlib_name = Some "client_ocurl";
                      lib_findlib_containers = [];
                      });
               Library
                 ({
                     ...
                     },
                   {
                      bs_build =
                        [
                           (OASISExpr.EBool true, false);
                           (OASISExpr.EFlag "client_ocamlnet", true)
                        ];
                      bs_install =
                        [
                           (OASISExpr.EBool true, false);
                   ...
                   {
                      lib_modules = ["Oauth_netclient_http_client"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "ooauth";
                      lib_findlib_name = Some "client_ocamlnet";
                      lib_findlib_containers = [];
                      });
               Library
                 ({
                     ...
                     },
                   {
                      bs_build =
                        [
                           (OASISExpr.EBool true, false);
                           (OASISExpr.EFlag "server_ocamlnet", true)
                        ];
                      bs_install =
                        [
                           (OASISExpr.EBool true, false);
                   ...
                   {
                      lib_modules = ["Oauth_netcgi_http"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "ooauth";
                      lib_findlib_name = Some "server_ocamlnet";
                      lib_findlib_containers = [];
                      });
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "build the test programs";
                      flag_default = [(OASISExpr.EBool true, true)];
                      });
               Executable
                 ({
                     cs_name = "termie_client";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
                      bs_build =
                        [
                           (OASISExpr.EBool true, false);
                           (OASISExpr.EFlag "testprogs", true)
                        ];
                      ...
                      bs_build_depends =
                        [
                           FindlibPackage ("crypto_keys", None);
                           InternalLibrary "client_ocamlnet"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                 ...
                 ({
                     ...
                     },
                   {
                      ...
                      bs_build_depends =
                        [
                           FindlibPackage ("crypto_keys", None);
                           InternalLibrary "server_ocamlnet"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "\161\140aE\000\250m=>\184\136F\148\031X\225";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
